...
curl localhost:9090/characters -XPOST -d '{"name":"addName", "user_id":"a2181017-5c53-422b-b6bc-036b27c04fc8"}'
curl localhost:9090/characters -XPUT -d '{"id":"e2382ea2-b5fa-4506-aa9d-d338aa52af44", "name":"newName", "user_id":"a2181017-5c53-422b-b6bc-036b27c04fc8"}'
